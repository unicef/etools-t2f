...
function config() {
  global.config.build.rootDirectory = path.join('../core/assets/frontend/', global.config.appName);
  global.config.build.templateDirectory = path.join('../core/templates/frontend/', global.config.appName);
